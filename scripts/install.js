...
const log = (msg) => console.log('\x1b[1;32m[INFO]\x1b[0m', msg);
const err = (msg) => console.error('\x1b[1;31m[ERROR]\x1b[0m', msg);
const warn = (msg) => console.warn('\x1b[1;33m[WARN]\x1b[0m', msg);
...
async function main() {
  ...
  const exclude = new Set(['scripts', 'install.sh', 'install.ps1', 'install.js', 'prompt.js', 'package.json', 'package-lock.json', 'node_modules']);

  for (const entry of readdirSync(SKILL_SOURCE_DIR, { withFileTypes: true })) {
